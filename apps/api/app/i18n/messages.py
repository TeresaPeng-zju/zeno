...
MESSAGES: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "note.resource": (
            "Resource prescriptions are generated by the RAG resource engine "
            "(pgvector recall + multi-signal rerank + freshness check)."
        ),
    ...
    "zh": {
        ...
        # Result note + resource retrieval query
        "note.resource": (
            "资源处方由 RAG 资源引擎（pgvector 召回 + 多信号重排 + 保鲜校验）生成。"
        ),
